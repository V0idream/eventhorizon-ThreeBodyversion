...
public static class AndroidDevelopmentBuild
{
    ...
    private const string VersionName = "Alpha 1.34";
    private const int VersionCode = 113934;
    ...
    public static void Build()
    {
        ...
        var outputPath = Path.Combine(outputDirectory, "ThreeBody-EventHorizon-Alpha-1.34.apk");
