...
public static class AndroidDevelopmentBuild
{
    ...
    private const string VersionName = "Alpha 1.31";
    private const int VersionCode = 113931;
    ...
    public static void Build()
    {
        ...
        var outputPath = Path.Combine(outputDirectory, "ThreeBody-EventHorizon-Alpha-1.31.apk");
