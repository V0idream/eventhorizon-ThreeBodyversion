...
public static class AndroidDevelopmentBuild
{
    ...
    private const string VersionName = "Alpha 1.7";
    private const int VersionCode = 113701;
    ...
    public static void Build()
    {
        ...
        var outputPath = Path.Combine(outputDirectory, "ThreeBody-EventHorizon-Alpha-1.7.apk");
