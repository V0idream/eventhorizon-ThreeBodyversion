...
public static class AndroidDevelopmentBuild
{
    ...
    private const string VersionName = "Alpha 1.8";
    private const int VersionCode = 113801;
    ...
    public static void Build()
    {
        ...
        var outputPath = Path.Combine(outputDirectory, "ThreeBody-EventHorizon-Alpha-1.8.apk");
