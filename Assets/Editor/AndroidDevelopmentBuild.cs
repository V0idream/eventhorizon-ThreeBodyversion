...
public static class AndroidDevelopmentBuild
{
    ...
    private const string VersionName = "Alpha 1.11";
    private const int VersionCode = 113911;
    ...
    public static void Build()
    {
        ...
        var outputPath = Path.Combine(outputDirectory, "ThreeBody-EventHorizon-Alpha-1.11.apk");
