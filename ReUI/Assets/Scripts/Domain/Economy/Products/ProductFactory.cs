...
namespace Economy.Products
{
    public class ProductFactory
    {
        ...
        public IProduct CreatePlayerProduct(IItemType itemType, int quantity = 1, int inversedPriceScale = 2)
        {
            ...
            IPriceProvider priceProvider = IsRestrictedTradeItem(itemType)
                ? RestrictedTradePriceProvider.Instance
                : new PlayerInventoryPriceProvider(_playerResources, itemType, inversedPriceScale);
        ...
        public IProduct CreateCargoHoldProduct(IItemType itemType, int quantity = 1)
        {
            ...
            IPriceProvider priceProvider = IsRestrictedTradeItem(itemType)
                ? RestrictedTradePriceProvider.Instance
                : new PlayerInventoryPriceProvider(_playerResources, itemType, 2);
            return new CommonProduct(itemType, quantityProvider, priceProvider);
        }
        ...
        public IProduct CreateMarketProduct(IItemType itemType, int quantity = 1, float priceScale = 2f)
        {
            ...
            IPriceProvider priceProvider = IsRestrictedTradeItem(itemType)
                ? RestrictedTradePriceProvider.Instance
                : new MarketPriceProvider(_playerResources, itemType, priceScale);
            return new CommonProduct(itemType, quantityProvider, priceProvider);
        }
        ...
        public IProduct CreateIapProduct(IItemType itemType)
        {
            ...
            IPriceProvider priceProvider = IsRestrictedTradeItem(itemType)
                ? RestrictedTradePriceProvider.Instance
                : new MarketPriceProvider(_playerResources, itemType.Price);
            return new CommonProduct(itemType, quantityProvider, priceProvider);
        }
        ...
        public IProduct CreateArenaProduct(IItemType itemType, Price price)
        {
            ...
            IPriceProvider priceProvider = IsRestrictedTradeItem(itemType)
                ? RestrictedTradePriceProvider.Instance
                : new MarketPriceProvider(_playerResources, price);
            return new CommonProduct(itemType, quantityProvider, priceProvider);
        }
        ...
        private static bool IsRestrictedTradeItem(IItemType itemType)
        {
            return itemType is ComponentItem componentItem &&
